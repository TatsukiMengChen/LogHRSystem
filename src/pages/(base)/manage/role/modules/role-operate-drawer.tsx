...
const RoleOperateDrawer: FC<Props> = memo(
  ({ form, handleSubmit, onClose, open, operateType, routes, rowId, setMenuAuthData }) => {
    console.log(routes);
    ...
    // const handleSetMenuAuthData = (data: any) => {};
